...
export const mockedMoviesList = [
	{
		...
		overview: `Determined to prove herself, Officer Judy Hopps, the first bunny on Zootopia's police force, jumps at the chance 
			to crack her first case - even if it means partnering with scam-artist fox Nick Wilde to solve the mystery.`,
		budget: 150000000,
		revenue: 1023784195,
